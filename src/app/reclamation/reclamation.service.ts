...
export class ReclamationService {
  ...
  createReclamation(reclamation: any, userId:number): Observable<object> {
    return this.http.post(`${this.baseUrl}/${userId}`, reclamation);
  }
  ...
  getAllReclamation(page: number, size: number, exactly:String): Observable<any> {
    ...
    return this.http.get(`${this.baseUrl}/${exactly}`, { params });
  }
